...
# MAGIC 1. Select "Catalog Name"
# MAGIC 1. Select "database/schema name"
# MAGIC 1. Select "engine events table name"
# MAGIC 1. For dataframe name, provide appropriate name to differentiate with other names
# MAGIC 1. click on "Execute". This will initialize the bamboolib UI.
# MAGIC
...
# MAGIC
# MAGIC 1. Follow the steps used to load engine event data. Name the dataframe uom_conversion_df
...
# MAGIC
# MAGIC ### 1 - Write data to database
# MAGIC
# MAGIC Let's create the silver table for engine event data 
# MAGIC
# MAGIC 1. In the search actions dropdown, search for "Write to datbase table" and click on action. 
# MAGIC
# MAGIC 1. On the right panel, enter the database name (wwid_capstone) and table name engine_event_silver. 
# MAGIC
# MAGIC 1. Click on execute.
...
# MAGIC
# MAGIC 1. Follow the steps used to load engine event data. Name the dataframe engine_df
# MAGIC 2. Save the transformed data in table named engine_silver
...
# MAGIC
# MAGIC 1. Follow the steps used to load engine event data. Name the dataframe engine_failure_df
# MAGIC 2. Save the transformed data in table named engine_failure_silver
...
# MAGIC
# MAGIC 1. Follow the steps used mentioned before to load, join, aggregate and save the gold/feature table
# MAGIC 2. Save the transformed data in table named engine_features
